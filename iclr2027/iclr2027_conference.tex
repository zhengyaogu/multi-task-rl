...
Suppose that each task-wise utility $U_{t,k}$ is twice-differentiable and assumption~\ref{eq:constraint_upper_bound} stands. Let $F_t(p) = \mathbf{1}^T U_t(p)$ denote the total policy improvement at iteration $t$, and let
\[
p_T^\star
\in
