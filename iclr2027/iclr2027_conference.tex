...
\textcolor{blue}{Good idea, although right now the background is folded in to methods.\\
Maybe we can write the Background section around Aioli?}


\textcolor{red}{Yeah I feel like multi-task problem formulation is not something everyone is familiar with}
