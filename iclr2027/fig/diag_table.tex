...
\textsc{PDCM}$_{\mathrm{diag}}$ keeps only its diagonal, treating each tasks improvement as a
univariate function $\widehat U_{t,k}(p_{t,k})$ of its own share (\Cref{app:diagonal});
Uniform is the even-split baseline. Best per task in \textbf{bold}, second best in
\underline{underline}.}
\vspace{-0.1in}
