...
Naively maximizing the total policy improvement in \Cref{eq:bg_telescope} can lead to skewed development
over tasks that should otherwise be treated equally. To address this, 
we enforce the following constraint that prevents any task from falling behind
...
counterfactual policy improvement of a uniform baseline. Recent work~\citep{ye2025datamixinglawsoptimizing,chen2025aioli,kang2025autoscalescaleawaredatamixing} suggests that the policy-improvement surface with respect to mixture allocation is approximately concave along linear interpolation paths. We take this as our standing assumption.
